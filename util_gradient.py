...
def unpack(theta, K):
    ...
    curr_ind += num_items
    gamma_users = theta[
        curr_ind: curr_ind + num_users * K].reshape((num_users, K))
    curr_ind += num_users * K
...
def gradient_only_beta(theta, grad_buffer, rating_array, lam, K):
    # unpack theta
    alpha, beta_users, beta_items, gamma_users, gamma_items = unpack(theta, K)
    # reset and unpack grad_buffer
    grad_buffer.fill(0.)
...
def gradient_only_beta_user(theta, grad_buffer, rating_array, lam, K):
    # unpack theta
    alpha, beta_users, beta_items, gamma_users, gamma_items = unpack(theta, K)
    # reset and unpack grad_buffer
    grad_buffer.fill(0.)
...
def gradient_only_beta_item(theta, grad_buffer, rating_array, lam, K):
    # unpack theta
    alpha, beta_users, beta_items, gamma_users, gamma_items = unpack(theta, K)
    # reset and unpack grad_buffer
    grad_buffer.fill(0.)
...
def gradient_only_not_gamma(theta, grad_buffer, rating_array, lam, K):
        # unpack theta
    alpha, beta_users, beta_items, gamma_users, gamma_items = unpack(theta, K)
    # reset and unpack grad_buffer
    grad_buffer.fill(0.)
...
def gradient_only_gamma(theta, grad_buffer, rating_array, lam, K):
    # unpack theta
    alpha, beta_users, beta_items, gamma_users, gamma_items = unpack(theta, K)
    # reset and unpack grad_buffer
    grad_buffer.fill(0.)
...
def gradient_only_gamma_user(theta, grad_buffer, rating_array, lam, K):
    # unpack theta
    alpha, beta_users, beta_items, gamma_users, gamma_items = unpack(theta, K)
    # reset and unpack grad_buffer
    grad_buffer.fill(0.)
...
def gradient_only_gamma_item(theta, grad_buffer, rating_array, lam, K):
    # unpack theta
    alpha, beta_users, beta_items, gamma_users, gamma_items = unpack(theta, K)
    # reset and unpack grad_buffer
    grad_buffer.fill(0.)
